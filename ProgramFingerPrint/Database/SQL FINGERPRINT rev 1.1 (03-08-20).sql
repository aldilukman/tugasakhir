...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2020 at 11:52 PM
...
--
ALTER TABLE `fingerprint`
  MODIFY `IDFINGERPRINT` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `identitas`
  MODIFY `IDIDENTITTAS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `jadwalkuliah`
  MODIFY `IDJADWALKULIAH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
